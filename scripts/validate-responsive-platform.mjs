...
const checks = [
  ...
  ['notification drawer has a notification centre action', navbarJsx.includes("onNavigate('operationscenter')") && navbarJsx.includes('View all notifications')],
  ...
  ['notification category icons use source metadata', navbarJsx.includes('getNotificationCategory(notification)') && navbarJsx.includes('<NotificationTypeIcon')],
